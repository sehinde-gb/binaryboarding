...
Class EnsPortal.EDI.devTemplate Extends EnsPortal.Template.devPage [ Abstract, System = 4 ]
{
...
ClassMethod DrawError(errorDetail As %String) As %Status
{
  ...
  &html<<div class="errorTxt"><span class="errorDetail">#(errorDetail)#</span> #(errorTxt)#</div>>
  Quit $$$OK
}
